...
plot for [col=9:19] 'benchmark.csv' index 0 using 1:col lw 2 ps 0.5 with linespoints title columnhead
...
plot for [col=9:19] 'benchmark.csv' index 1 using 1:col lw 2 ps 0.5 with linespoints title columnhead
...
plot 'benchmark.csv' index 0 using 1:9 ls 1 with linespoints,\
	...
	'benchmark.csv' index 0 using 1:15 ls 4 with linespoints,\
	'benchmark.csv' index 0 using 1:16 ls 5 with linespoints
