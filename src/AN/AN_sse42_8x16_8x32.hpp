...
struct AN_sse42_8x16_8x32 :
    ...
    void RunEncode(
        ...
        for (size_t iteration = 0; iteration < config.numIterations; ++iteration) {
            auto *mm_Data = this->bufRaw.template begin<__m128i >();
            auto * const mm_DataEnd = this->bufRaw.template end<__m128i >();
            auto *mm_Out = this->bufEncoded.template begin<__m128i >();
