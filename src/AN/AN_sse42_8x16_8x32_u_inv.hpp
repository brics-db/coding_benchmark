...
struct AN_sse42_8x16_8x32_u_inv : public AN_sse42_8x16_8x32<uint16_t, uint32_t, UNROLL> {

    AN_sse42_8x16_8x32_u_inv (const char* const name, AlignedBlock & in, AlignedBlock & out, uint32_t A, uint32_t Ainv) :
