...
__m128i hamming_t<uint16_t, __m256i >::computeHamming(
    ...
    __m128i tmp2 = SIMD<__m256i, uint16_t>::popcount(_mm256_and_si256(data, pattern1));
    __m128i hamming = _mm_slli_epi16(_mm_and_si128(tmp2, mask), 1);
    __m128i tmp1 = SIMD<__m256i, uint16_t>::popcount(_mm256_and_si256(data, pattern2));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 2));
    tmp1 = SIMD<__m256i, uint16_t>::popcount(_mm256_and_si256(data, pattern3));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 3));
    tmp1 = SIMD<__m256i, uint16_t>::popcount(_mm256_and_si256(data, pattern4));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 4));
    tmp1 = SIMD<__m256i, uint16_t>::popcount(_mm256_and_si256(data, pattern5));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 5));
    tmp1 = _mm_add_epi8(SIMD<__m256i, uint16_t>::popcount(std::forward<__m256i >(data)), tmp2);
    tmp1 = _mm_and_si128(tmp1, mask);
...
__m128i hamming_t<uint16_t, __m256i >::computeHamming2(
    ...
    static auto pattern5 = _mm256_set1_epi16(static_cast<int16_t>(0xF800));
    static auto mask = _mm_set1_epi8(0x01);
    __m128i tmp2 = SIMD<__m256i, uint16_t>::popcount2(_mm256_and_si256(data, pattern1));
    __m128i hamming = _mm_slli_epi16(_mm_and_si128(tmp2, mask), 1);
    __m128i tmp1 = SIMD<__m256i, uint16_t>::popcount2(_mm256_and_si256(data, pattern2));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 2));
    tmp1 = SIMD<__m256i, uint16_t>::popcount2(_mm256_and_si256(data, pattern3));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 3));
    tmp1 = SIMD<__m256i, uint16_t>::popcount2(_mm256_and_si256(data, pattern4));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 4));
    tmp1 = SIMD<__m256i, uint16_t>::popcount2(_mm256_and_si256(data, pattern5));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 5));
    tmp1 = _mm_add_epi8(SIMD<__m256i, uint16_t>::popcount2(std::forward<__m256i >(data)), tmp2);
    tmp1 = _mm_and_si128(tmp1, mask);
    hamming = _mm_or_si128(hamming, tmp1);
    return hamming;
}
...
__m128i hamming_t<uint16_t, __m256i >::computeHamming3(
    ...
    static auto pattern5 = _mm256_set1_epi16(static_cast<int16_t>(0xF800));
    static auto mask = _mm_set1_epi8(0x01);
    __m128i tmp2 = SIMD<__m256i, uint16_t>::popcount3(_mm256_and_si256(data, pattern1));
    __m128i hamming = _mm_slli_epi16(_mm_and_si128(tmp2, mask), 1);
    __m128i tmp1 = SIMD<__m256i, uint16_t>::popcount3(_mm256_and_si256(data, pattern2));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 2));
    tmp1 = SIMD<__m256i, uint16_t>::popcount3(_mm256_and_si256(data, pattern3));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 3));
    tmp1 = SIMD<__m256i, uint16_t>::popcount3(_mm256_and_si256(data, pattern4));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 4));
    tmp1 = SIMD<__m256i, uint16_t>::popcount3(_mm256_and_si256(data, pattern5));
    tmp1 = _mm_and_si128(tmp1, mask);
    tmp2 = _mm_xor_si128(tmp2, tmp1);
    hamming = _mm_or_si128(hamming, _mm_slli_epi16(tmp1, 5));
    tmp1 = _mm_add_epi8(SIMD<__m256i, uint16_t>::popcount3(std::forward<__m256i >(data)), tmp2);
    tmp1 = _mm_and_si128(tmp1, mask);
    hamming = _mm_or_si128(hamming, tmp1);
    return hamming;
}
...
uint64_t hamming_t<uint32_t, __m256i >::computeHamming(
    ...
    tmp2 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern1)) & 0x0101010101010101;
    hamming |= tmp2 << 1;
    tmp1 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern2)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 2;
    tmp1 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern3)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 3;
    tmp1 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern4)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 4;
    tmp1 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern5)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 5;
    tmp1 = SIMD<__m256i, uint32_t>::popcount(_mm256_and_si256(data, pattern6)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 6;
    hamming |= (SIMD<__m256i, uint32_t>::popcount(std::forward<__m256i >(data)) + tmp2) & 0x0101010101010101;
    return hamming;
}
...
uint64_t hamming_t<uint32_t, __m256i >::computeHamming2(
    ...
    uint64_t hamming = 0;
    uint64_t tmp1(0), tmp2(0);
    tmp2 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern1)) & 0x0101010101010101;
    hamming |= tmp2 << 1;
    tmp1 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern2)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 2;
    tmp1 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern3)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 3;
    tmp1 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern4)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 4;
    tmp1 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern5)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 5;
    tmp1 = SIMD<__m256i, uint32_t>::popcount2(_mm256_and_si256(data, pattern6)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 6;
    hamming |= (SIMD<__m256i, uint32_t>::popcount2(std::forward<__m256i >(data)) + tmp2) & 0x0101010101010101;
    return hamming;
}
...
uint64_t hamming_t<uint32_t, __m256i >::computeHamming3(
    ...
    uint64_t hamming = 0;
    uint64_t tmp1(0), tmp2(0);
    tmp2 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern1)) & 0x0101010101010101;
    hamming |= tmp2 << 1;
    tmp1 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern2)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 2;
    tmp1 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern3)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 3;
    tmp1 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern4)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 4;
    tmp1 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern5)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 5;
    tmp1 = SIMD<__m256i, uint32_t>::popcount3(_mm256_and_si256(data, pattern6)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 6;
    hamming |= (SIMD<__m256i, uint32_t>::popcount3(std::forward<__m256i >(data)) + tmp2) & 0x0101010101010101;
    return hamming;
}
