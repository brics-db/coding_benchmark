...
uint64_t hamming_t<uint16_t, __m128i >::computeHamming3(
    ...
    uint64_t hamming = 0;
    uint64_t tmp1(0), tmp2(0);
    tmp2 = SIMD<__m128i, uint16_t>::popcount3(_mm_and_si128(data, pattern1)) & 0x0101010101010101;
    hamming |= tmp2 << 1;
    tmp1 = SIMD<__m128i, uint16_t>::popcount3(_mm_and_si128(data, pattern2)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 2;
    tmp1 = SIMD<__m128i, uint16_t>::popcount3(_mm_and_si128(data, pattern3)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 3;
    tmp1 = SIMD<__m128i, uint16_t>::popcount3(_mm_and_si128(data, pattern4)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 4;
    tmp1 = SIMD<__m128i, uint16_t>::popcount3(_mm_and_si128(data, pattern5)) & 0x0101010101010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 5;
    hamming |= (SIMD<__m128i, uint16_t>::popcount3(data) + tmp2) & 0x0101010101010101;
    return hamming;
}
...
uint32_t hamming_t<uint32_t, __m128i >::computeHamming3(
    ...
    uint32_t hamming = 0;
    uint32_t tmp1(0), tmp2(0);
    tmp2 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern1)) & 0x01010101;
    hamming |= tmp2 << 1;
    tmp1 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern2)) & 0x01010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 2;
    tmp1 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern3)) & 0x01010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 3;
    tmp1 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern4)) & 0x01010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 4;
    tmp1 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern5)) & 0x01010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 5;
    tmp1 = SIMD<__m128i, uint32_t>::popcount3(_mm_and_si128(data, pattern6)) & 0x01010101;
    tmp2 ^= tmp1;
    hamming |= tmp1 << 6;
    hamming |= (SIMD<__m128i, uint32_t>::popcount3(data) + tmp2) & 0x01010101;
    return hamming;
}
