            ...
            struct mm512<uint8_t> {
...
#else
                    return _mm512_set_epi32((static_cast<uint32_t>(v0 + 63) << 24) | (static_cast<uint32_t>(v0 + 62) << 16) | (static_cast<uint32_t>(v0 + 61) << 8) | (static_cast<uint32_t>(v0 + 60)),
                ...
                static inline __m512i set_inc(
                    ...
                    return _mm512_set_epi32(
                            ...
                            (static_cast<uint32_t>(v0 + 3 * inc) << 24) | (static_cast<uint32_t>(v0 + 2 * inc) << 16) | (static_cast<uint32_t>(v0 + 1 * inc) << 8) | (static_cast<uint32_t>(v0)));
#endif
                }
