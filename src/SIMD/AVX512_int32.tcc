...
#define MASK(idx) ((mask & idx) ? 0xFFFFFFFF : 0)
                    ...
                    return set(MASK(0x8000), MASK(0x4000), MASK(0x2000), MASK(0x1000), MASK(0x0800), MASK(0x0400), MASK(0x0200), MASK(0x0100), MASK(0x0080), MASK(0x0040), MASK(0x0020), MASK(0x0010),
                            MASK(0x0008), MASK(0x0004), MASK(0x0002), MASK(0x0001));
#undef MASK
                }
