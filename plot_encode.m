...
plot 'benchmark.csv' using 1:2 lw 2 ps 0.5 with linespoints title columnhead,\
	for [col=13:18] 'benchmark.csv' using 1:col lw 2 ps 0.5 with linespoints title columnhead

set output 'plot_encode_32bit_seq.pdf'
plot 'benchmark.csv' using 1:2 lw 2 ps 0.5 with linespoints title columnhead,\
	for [col=19:20] 'benchmark.csv' using 1:col lw 2 ps 0.5 with linespoints title columnhead

	set output 'plot_encode_32bit_vec.pdf'
	plot 'benchmark.csv' using 1:2 lw 2 ps 0.5 with linespoints title columnhead,\
		for [col=21:22] 'benchmark.csv' using 1:col lw 2 ps 0.5 with linespoints title columnhead
