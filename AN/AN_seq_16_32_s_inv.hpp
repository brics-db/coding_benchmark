...
struct AN_seq_16_32_s_inv : public ANTest<int16_t, int32_t, UNROLL>, public SequentialTest
{

	AN_seq_16_32_s_inv(const char* const name, AlignedBlock & in, AlignedBlock & out, int32_t A = 63'877l, int32_t Ainv = -784'197'811l) :
