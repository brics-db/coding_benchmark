...
struct AN_avx2_16x16_16x32_divmod : public ANTest<uint16_t, uint32_t, UNROLL>, public AVX2Test
{
		...
		for (size_t iteration = 0; iteration < numIterations; ++iteration)
		{
			...
			while (data <= (dataEnd - UNROLL))
			{
				...
				for (size_t k = 0; k < UNROLL; ++k)
				{
					...
					if ((_mm256_extract_epi32(mmIn, 0) % A != 0) || (_mm256_extract_epi32(mmIn, 1) % A != 0) || (_mm256_extract_epi32(mmIn, 2) % A != 0) || (_mm256_extract_epi32(mmIn, 3) % A != 0) || (_mm256_extract_epi32(mmIn, 4) % A != 0) || (_mm256_extract_epi32(mmIn, 5) % A != 0) || (_mm256_extract_epi32(mmIn, 6) % A != 0) || (_mm256_extract_epi32(mmIn, 7) % A != 0))
